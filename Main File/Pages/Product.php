...
<?php
    $qry = "select * from productcategory";
...
<section class="products" id="products">
    ...
    <br/>
    <br/>
    <h1 class="heading"> Organic <span><?php echo $rw["categoryname"]; ?></span> </h1>
...
<?php
    ...
    $qry2 = "select * from productdetails where category='".$rw["categoryname"]."'";
    ...
    <form method="post" action="cart.php?action=add&id=<?php echo $row['id']; ?>">
            ...
            <div class="swiper-slide box">
                ...
                <div class="stars"> 
                   ...
                   <a href="https://web.whatsapp.com/" class="links"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
