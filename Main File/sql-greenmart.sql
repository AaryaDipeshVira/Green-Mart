...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2022 at 06:43 AM
...
INSERT INTO `contactus` (`id`, `name`, `emailid`, `phonenumber`, `subject`, `message`) VALUES
(1, 'sadf', 'sadfds@g.conm', '2154254123', 'asdfads', 'asfdads');
...
(6, 'DEF', 'Avacado', '100', '12', 'Kashmiri Avacado', 'Fruits', '../image/Img (1).png');
...
INSERT INTO `users` (`id`, `name`, `emailid`, `phonenumber`, `userlocation`, `password`) VALUES
(1, 'Abc', 'abc@gmail.com', '', 'address', '1234567890'),
(2, 'abcde', 'Abcde@gmail.com', '', 'asdd', 'ABC'),
(3, 'def', 'def@gmail.com', '1234567890', 'address', '1234567890');
